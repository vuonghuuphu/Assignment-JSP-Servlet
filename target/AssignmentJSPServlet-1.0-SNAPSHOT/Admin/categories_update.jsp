...
<%
    Categories p = (Categories)request.getAttribute("d");
%>
<html>
<title>W3.CSS</title>
...
<form class="w3-container" action="/AssignmentJSPServlet_war_exploded/admin/updatecategories" method="post" name="From_Create">
