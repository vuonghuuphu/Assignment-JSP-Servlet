...
<div class="w3-container">
    ...
    <a href="/AssignmentJSPServlet_war_exploded/admin/From"><p><button class="w3-button w3-block w3-teal">Thêm mới</button></p></a>
        ...
        <tr class="w3-red">
            ...
            <tr>
              ...
              <td><img src="<%=obj.getImg()%>" style="width: 100px "></td>
                <td><a href="/AssignmentJSPServlet_war_exploded/admin/detailcategories?id=<%=obj.getId()%>">Chi tiết</a></td>
                <td><a href="/AssignmentJSPServlet_war_exploded/admin/updatecategories?id=<%=obj.getId()%>">Sửa</a></td>
                <td><a href="/AssignmentJSPServlet_war_exploded/admin/deletecategories?id=<%=obj.getId()%>" class="btndelete">Xóa</a></td>
            </tr>
