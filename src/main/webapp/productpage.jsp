...
<%
    List<Product> listproduct = (List<Product>)request.getAttribute("l");
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container">
    <div class="row">
            ...
            %>
                <div class="col-md-3" style="background-color: antiquewhite;margin:30px">
                    ...
                    <div><a href="/AssignmentJSPServlet_war_exploded/food/cartpage?id=<%=p.getId()%>" style="margin: 5px">
                        <button type="button" class="btn btn-info">Thêm vào giỏ hàng</button>
                    </a></div>
                    <div><a href="/AssignmentJSPServlet_war_exploded/food/detailpage?id=<%=p.getId()%>" style="margin: 5px">
